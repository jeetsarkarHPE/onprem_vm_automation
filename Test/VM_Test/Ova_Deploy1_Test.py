...
def main():
    parser = cli.Parser()
    # added cli.Argument.CLUSTER_NAME
    parser.add_optional_arguments(cli.Argument.OVA_PATH, cli.Argument.DATACENTER_NAME,
                                  cli.Argument.RESOURCE_POOL, cli.Argument.DATASTORE_NAME,cli.Argument.CLUSTER_NAME)
...
class FileHandle(object):
    def __init__(self, filename):
        ...
        self.fh = open(filename, 'rb') #Read binary Mode
